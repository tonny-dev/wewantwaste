        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-3xl shadow-lg border border-gray-100 p-8">
            ...
            <form onSubmit={handleSubmit}>
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className="w-full p-3 bg-blue-600 border border-gray-600 rounded-lg text-white focus:outline-none focus:border-blue-500"
                        >
                  ...
                  <div className="mb-6">
                    <label className="flex items-center">
                      <input
                        ...
                        className="w-4 h-4 text-blue-600 bg-blue-600 border-gray-600 rounded focus:ring-blue-500"
                      />
              ...
              {paymentMethod === "googlepay" && (
                <div className="mb-8">
                  <div className="p-8 bg-blue-600 rounded-lg text-center">
                    <div className="mb-6">
              ...
              <div className="flex space-x-4">
                <button
                  ...
                  onClick={onBack}
                  disabled={processing}
                  className="flex-1 px-6 py-3 bg-gray-600 text-white rounded-lg font-semibold hover:bg-blue-600 transition-colors disabled:bg-gray-500 disabled:cursor-not-allowed"
                >
                  Back
                </button>
